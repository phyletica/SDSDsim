...
class TestHeight:
    ...
    def test_n_leaves(self):
        ...
        assert root.number_of_leaves == 5
        assert root.number_of_extant_leaves == 5
        assert root.number_of_extinct_leaves == 0

        l3.is_extinct = True
        assert root.number_of_leaves == 5
        assert root.number_of_extant_leaves == 4
        assert root.number_of_extinct_leaves == 1

        l5.is_extinct = True
        assert root.number_of_leaves == 5
        assert root.number_of_extant_leaves == 3
        assert root.number_of_extinct_leaves == 2

        l1.is_extinct = True
        assert root.number_of_leaves == 5
        assert root.number_of_extant_leaves == 2
        assert root.number_of_extinct_leaves == 3

        l2.is_extinct = True
        assert root.number_of_leaves == 5
        assert root.number_of_extant_leaves == 1
        assert root.number_of_extinct_leaves == 4

        l4.is_extinct = True
        assert root.number_of_leaves == 5
        assert root.number_of_extant_leaves == 0
        assert root.number_of_extinct_leaves == 5
